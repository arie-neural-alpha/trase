...
COMMENT ON VIEW public.chart_attributes_v IS 'Materialized view which merges chart_inds, chart_quals and chart_quants with chart_attributes.';
...
COMMENT ON VIEW public.dashboards_attributes_v IS 'Materialized view which merges dashboards_inds, dashboards_quals and dashboards_quants with dashboards_attributes.';
...
COMMENT ON VIEW public.download_attributes_v IS 'Materialized view which merges download_quals and download_quants with download_attributes.';
...
COMMENT ON VIEW public.map_attributes_v IS 'Materialized view which merges map_inds and map_quants with map_attributes.';
...
COMMENT ON VIEW public.recolor_by_attributes_v IS 'Materialized view which merges recolor_by_inds and recolor_by_quals with recolor_by_attributes.';
...
COMMENT ON VIEW public.resize_by_attributes_v IS 'Materialized view which merges resize_by_quants with resize_by_attributes.';
